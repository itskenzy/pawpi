...
// Fungsi untuk menampilkan hati
function showHeart() {
  // Hapus semua elemen animasi
  const svgContainer = qs(".svg-container");
  ...
  // Arahkan ke note.html saat hati diklik
...
// Jalankan animasi dan hentikan setelah 2 loop
loveTl.play();
...
setInterval(() => {
  ...
  if (loopCount === 2) {
    loveTl.stop(); // Hentikan animasi
    
    // Redirect langsung ke note.html setelah animasi selesai
    window.location.href = "note.html";
